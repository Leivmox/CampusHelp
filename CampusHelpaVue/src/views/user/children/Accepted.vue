        ...
        <el-card class="box-card">
            ...
            <el-card class="box-card" style="margin-top: 20px" v-for="item in tasks">
                <div slot="header" class="clearfix"
                    ...
                    <template>
                        <el-popconfirm title="确定取消求助吗" @confirm="del(item.id)">
                            <el-button style="float: right; padding: 3px 0" type="text" slot="reference"
                                       v-show="item.state != 2">取消求助
                            </el-button>
                        </el-popconfirm>
                    </template>
                </div>
            ...
            <div style="text-align: center">
                <span v-if="tasks.length == 0"><i class="el-icon-refresh-right"></i>暂无发布求助</span>
            </div>
    ...
    export default {
        ...
        methods: {
            del(id) {
                ...
                .then(res => {
                    this.$notifyMsg('成功', '取消求助成功', 'success')
                    this.newList()
                })
            },
            newList() {
