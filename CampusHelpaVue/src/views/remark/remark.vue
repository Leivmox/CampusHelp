<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="求助id" prop="taskId">
        <el-input
      ...
      <el-form-item label="互助者id" prop="acceptId">
        <el-input
          v-model="queryParams.acceptId"
          placeholder="请输入互助者id"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="remarkList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="求助id" align="center" prop="taskId" />
      <el-table-column label="互助者id" align="center" prop="acceptId" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="求助id" prop="taskId">
          <el-input v-model="form.taskId" placeholder="请输入求助id" />
        </el-form-item>
        <el-form-item label="互助者id" prop="acceptId">
          <el-input v-model="form.acceptId" placeholder="请输入互助者id" />
        </el-form-item>
        <el-form-item label="评价人id" prop="publishId">
